                ...
                <div className="mt-20  md:w-[40rem] mx-auto text-center flex flex-col gap-4 md:pl-10 ">
                    <div className="flex justify-center">
                        <div className="flex gap-4 ">
                            ...
                            <img src={Logo1} alt="logo1" className="h-[35px] ml-1.5"></img>
                            <img src={Logo2} alt="logo2" className="h-[35px] ml-1.5"></img>
                            <img src={tkm_it} alt="logo1" className="h-[35px] ml-1.5"></img>


                            
                        </div>
                    </div>
                    {/* <div className="text-[3.3rem] leading-tight font-bold md:text-8xl bg-gradient-to-b from-[#148ef9] to-[#50feff] bg-clip-text text-transparent">HACK4TKM</div> */}
                    <div>
...
<MainLogo/>
                    ...
                    <div className="text-3xl md:text-4xl font-semibold text-transparent bg-gradient-to-r from-[#148ef9] to-[#50feff] bg-clip-text">February 2024</div>
                    <div className="text-2xl md:text-4xl font-semibold text-transparent bg-gradient-to-l from-[#148ef9] to-[#50feff] bg-clip-text">16 | 17 | 18</div>
