    ...
    return (
        ...
        <div className="flex  w-full flex-col lg:flex-row justify-around h-full bg-black border-4 border-gradient-animation p-2 rounded-lg">
            <div className=" text-left flex flex-col h-full w-full lg:w-1/2 p-5 md:p-10 gap-5">
                <h1 className="font-bold text-4xl lg:text-5xl mb-2 underline underline-offset-8 decoration-dashed leading-snug">About <span className=' text-transparent bg-gradient-to-b from-[#148ef9] to-[#50feff] bg-clip-text'>HACK4TKM</span></h1>
