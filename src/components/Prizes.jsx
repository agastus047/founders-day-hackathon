...
const Prizes = () =>
{
    ...
    return(
        <div className="lg:mt-16 ">
         ...
         <div className="border border-gradient-animation  flex gap-2 md:gap-8 items-center justify-center md:mx-32 lg:mx-64 mx-8 rounded-2xl  p-5 lg:px-10" data-aos="flip-up" 
