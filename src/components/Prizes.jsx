...
const Prizes = () =>
{
    ...
    return(
        <div className="lg:mt-16 ">
         ...
         <div className="bg-gradient-to-l from-[#1b0362] to-[#50feff]  flex gap-2 md:gap-8 items-center justify-center md:mx-32 lg:mx-64 mx-8 rounded-tr-full rounded-bl-full  p-5 lg:px-16" data-aos="flip-up" 
