...
const Prizecard = ({prop}) =>
{
    return(
        ...
        <div data-aos="fade" className="bg-gray-800 text-white flex flex-col gap-5 rounded-xl items-center p-5 mx-5">
            ...
            <div className='text-xl lg:text-2xl bg-gradient-to-r from-blue-600 to-white text-transparent bg-clip-text  font-semibold'>{prop.prize}</div>
        </div>
