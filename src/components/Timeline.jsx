    ...
    <div className="h-auto w-full flex justify-center items-center">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-9 px-2">
        ...
        <div data-aos="fade" className="col-span-4 w-full h-full">
          <div className="w-auto h-auto bg-black border border-white p-4 rounded-xl p-2 py-4 md:pl-6">
        ...
        <div data-aos="fade" className="col-span-4 w-full h-full ">
          <div className="w-full h-full bg-black border border-white p-4 rounded-md p-2 py-4 md:pl-4">
            <h1 className="text-white text-xl text-center font-medium py-2">15 January 2024</h1>
            <p className="text-gray-100 sm:text-xl text-md text-center mb-2">Abstract Submission Ends.</p>
          </div>
        </div>
        <div data-aos="fade" className="col-span-4 w-full h-full ">
          <div className="w-full h-full bg-black border border-white p-4 rounded-md p-2 py-4 md:pl-4">
            <h1 className="text-white text-xl text-center font-medium py-2">20 January 2024</h1>
            <p className="text-gray-100 text-center sm:text-xl text-md mb-2">Announcement of Shortlisted 20 Teams.</p>
          </div>
        </div>
