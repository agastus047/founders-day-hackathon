  ...
  return (
    <div className="h-auto w-full flex justify-center items-center">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-9 px-2">
        ...
        <div data-aos="fade" className="col-span-4 w-full h-full ">
          <div className="w-full h-full bg-gray-800 rounded-md p-2 py-4 md:pl-4">
            <h1 className="text-white text-xl text-center font-medium py-2">20 January 2023</h1>
        ...
        <div data-aos="fade" className="col-span-4 w-full h-full ">
          <div className="w-full h-full bg-gray-800 rounded-md p-2 py-4 md:pl-4">
            <h1 className="text-white text-xl text-center font-medium py-2">19 February 2023</h1>
